...
/**
 * Comparator to be used when sorting a list of AudioBites based on their start time
 * @author Jakob Hougaard Andersen
 *
 */
public class AudioBiteStartComparator implements Comparator<AudioBite>
{
